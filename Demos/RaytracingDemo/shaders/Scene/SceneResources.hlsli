...
#define RAYTRACING_DEMO_TEXTURES_REGISTER register(t16, COMMON_ROOT_SIGNATURE_PIPELINE_SPACE)
#define RAYTRACING_DEMO_VERTEX_BUFFERS_REGISTER register(t48, COMMON_ROOT_SIGNATURE_PIPELINE_SPACE)
#define RAYTRACING_DEMO_INDEX_BUFFERS_REGISTER register(t304, COMMON_ROOT_SIGNATURE_PIPELINE_SPACE)
