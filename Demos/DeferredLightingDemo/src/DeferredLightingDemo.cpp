...

    {
...

        {
...

            {
                ...
                ShaderResourceView irradianceMapSrv(diffuseIrradianceMap, irradianceSrvDesc);
...

        {
            ...
            skyboxSrvDesc.Format = skybox->GetD3D12ResourceDesc().Format;
            ...
            auto skyboxSrv = ShaderResourceView(skybox, skyboxSrvDesc);
